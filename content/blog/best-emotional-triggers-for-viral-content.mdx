...
<a
  ...
  className="not-prose inline-flex items-center justify-center px-6 py-4 bg-gradient-to-br from-slate-900 to-slate-800 text-white rounded-xl font-bold hover:shadow-lg transition-all no-underline my-6"
>
